---
title: 常见问题
description: StoryForge 常见问题解答，涵盖安装配置、AI 使用、功能操作等各方面问题。
---
...
StoryForge 本身是 **开源免费** 的，但使用 AI 服务（如 OpenAI、DeepSeek 等）可能需要付费。
...
| 场景 | 推荐模型 |
|------|----------|
| 剧情分析 | GPT-5.4 / Claude Opus 4.6 |
| 脚本生成 | GPT-5.4 / Qwen 2.5-Max |
| 字幕翻译 | GPT-5.4 / DeepSeek V3.2 |
| 性价比首选 | **DeepSeek V3.2** |
...
StoryForge 批量处理支持 **无限数量** 的视频，具体取决于你的硬件性能和 AI 配额。
...
生产环境日志位置：
- **Windows**: `%APPDATA%/StoryForge/logs/`
- **macOS**: `~/Library/Logs/StoryForge/`
- **Linux**: `~/.config/StoryForge/logs/`
...
目前 StoryForge 界面支持 **中文** 和 **英文**。文档使用中文编写。
...
StoryForge 的核心功能需要 AI 服务支持，需要联网使用。但本地视频处理功能可以离线使用。

### 有移动端 App 吗？

目前 StoryForge 是 **桌面应用**，支持 Windows、macOS 和 Linux。移动端 App 正在规划中。
