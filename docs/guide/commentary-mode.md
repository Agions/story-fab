---
title: 解说模式
description: 解说模式完整操作指南，AI 自动将视频转化为带文案、配音、字幕的完整解说视频。
---
...
| 风格 | 适用场景 | 语言特点 |
|------|---------|---------|
| **幽默版** | 喜剧 / 搞笑视频 | 诙谐有趣，添加网络梗，常见"笑死""绝"等 |
| **接地气版** | 情感 / 生活类 | 口语化，像和朋友聊天，常见"真的""其实就是" |
| **震惊版** | 悬疑 / 复仇类短剧 | 夸张震惊，制造悬念，常见"天哪！""不敢相信" |
| **感动版** | 爱情 / 亲情类视频 | 温情脉脉，情感共鸣，常见"让人心疼""原来这就是" |
| **专业版** | 纪录片 / 科教类 | 客观冷静，纪录片风格，常见"值得注意的是""关键在于" |
...
|------|------|
| 输出格式 | MP4（H.264 + AAC） |
| 分辨率 | 1080×1920（9:16）/ 1080×1080（1:1）/ 1920×1080（16:9） |
| 码率 | 自动（根据平台优化） |
| 字幕 | 烧录 / SRT 文件 / 无字幕 |
