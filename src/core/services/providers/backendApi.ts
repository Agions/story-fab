...
// CutDeck is a local Tauri app; all operations run on-device.
...
export const analysisApi = { analyzeVideo: async () => ({}), getAnalysis: async () => ({}) };
export const scriptApi = { getScript: async () => ({}), generateScript: async () => ({}), updateScript: async () => ({}), deleteScript: async () => {} };
