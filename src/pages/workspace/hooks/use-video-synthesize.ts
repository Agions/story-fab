...
import { EFFECT_PRESET_MAP } from '../shared/compose-config';
import type { SynthesizeConfig } from '../shared/compose-config';
import { DEFAULT_SYNTHESIZE_CONFIG } from '../shared/compose-config';
